...
% \textbf{Data Scientist} and Software Developer with a strong track record at \textbf{Amazon} and a keen interest in \textbf{Natural Language Processing (NLP)}.Expert in leveraging analytics, \textbf{machine learning}, and software engineering to boost efficiency and engagement. Proficient in \textbf{AWS} and \textbf{deep learning} for innovative solutions. Seeks to merge data science expertise and software skills to foster business growth and actionable insights in a forward-looking role.
% \textbf{Software Engineer and Data Scientist} with a proven track record at \textbf{Amazon}, specializing in \textbf{machine learning} and \textbf{Natural Language Processing (NLP)}. Skilled in applying advanced analytics and \textbf{deep learning} techniques to enhance product development and operational efficiency. Proficient with \textbf{AWS} for deploying scalable, innovative solutions. Aims to integrate data science and software engineering skills to drive growth and provide impactful business insights.
...
\begin{itemize}[noitemsep]
    \item Developed and \textbf{fine-tuned deep learning models (LLMs)} for NLP applications using \textbf{Pytorch} for the Health department.
    \item Implemented \textbf{web scraping and Retrieval-Augmented Generation (RAG)} techniques with \textbf{LLamaIndex} \textbf{Langchain and LLMs prompting} to improve information retrieval tasks in the Department of Economics.
    \item \textbf{Annotated extensive corpora}, significantly enhancing data quality and availability for \textbf{machine learning projects} in the department of psychology.
\end{itemize}
...
\begin{itemize}[noitemsep]
    ...
    % \item \textbf{Significantly improved deployment efficiency and scalability} by optimizing with \textbf{AWS services (EC2, S3, Lambda, DynamoDB, API Gateway, CDK, and CloudFormation)}.
...
\begin{itemize}[noitemsep]
    % \item Played a key role in the \textbf{full-stack development} of critical internal tools using \textbf{JavaScript, Reactjs, Flask, Nodejs, HTML, and CSS}, directly benefiting over \textbf{9,000 Amazon employees through enhanced usability and productivity.}
    ...
    % \item \textbf{Directly benefited over 9,000 Amazon employees} by enhancing usability and productivity through key contributions to the full-stack development of critical internal tools, utilizing \textbf{JavaScript, Reactjs, Flask, Nodejs, HTML, and CSS}.
...
\begin{itemize}[noitemsep]
    \item Applied statistics and unsupervised learning techniques with \textbf{Python(scikit-learn)} to segment customers, driving \textbf{targeted marketing and product improvements.}
