...
\begin{itemize}[noitemsep]
    ...
    \item Implemented \textbf{web scraping and Retrieval-Augmented Generation (RAG)} techniques with \textbf{LLamaIndex} to improve information retrieval tasks in the Department of Economics.
\end{itemize}
